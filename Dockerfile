...
CMD [ "--http-address=0.0.0.0:4180", "--skip-provider-button=true", "--session-store-type=cookie", "--cookie-samesite=lax", "--cookie-secure=false", "--reverse-proxy=true", "--pass-access-token=true", "--pass-authorization-header=true", "--cookie-csrf-per-request=true", "--cookie-csrf-expire=15m", "--cookie-refresh=15m", "--set-xauthrequest=true", "--set-authorization-header=false", "--skip-auth-preflight=true" ]
